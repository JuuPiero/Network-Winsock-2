...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	{
		MessageBox(serverWindow, "Cannot associate a local address with server socket.", "Error!", MB_OK);
	}
...
HWND InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   for(i = 0; i <MAX_CLIENT; i++)
	   client[i] = 0;
   hWnd = CreateWindow("WindowClass", "WSAAsyncSelect TCP Server", WS_OVERLAPPEDWINDOW,
